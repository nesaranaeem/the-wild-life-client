      ...
      <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-lg text-center">
          ...
          <p className="mt-4 text-slate-900">
            I am a professional wild life photographer since 2012. here are some
            reason to hire me
          </p>
        </div>
        ...
        <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-2">
          ...
          <div className="block rounded-xl border border-gray-800 p-8 shadow-xl transition hover:border-pink-500/10 hover:shadow-pink-500/10">
            ...
            <p className="mt-1 text-sm text-zinc-900">
              I have visit 20+ countries including africa, brazil to capture the
              beautiful wildlife scenery.
            </p>
          </div>
        </div>
      </div>
